...
class AppmetricaPushHuaweiPlugin : FlutterPlugin, ActivityAware, PluginRegistry.NewIntentListener,
    BroadcastReceiver() {
    private val _tag = "AppmetricaPushHuawei.AppmetricaPushAndroidPlugin"
